...
✅ 아래 링크에서 영수증을 확인하세요:
${c.downloadUrl}`,sms:`[ElSpa] 영수증 ${c.receiptNumber} 발급 완료. 금액: ${c.amount.toLocaleString()}원. 상세보기: ${c.downloadUrl}`,email:`<h2>영수증 발급 완료</h2><p>안녕하세요!</p><p>지급이 완료되었습니다.</p><ul><li><strong>영수증 번호:</strong> ${c.receiptNumber}</li><li><strong>금액:</strong> ${c.amount.toLocaleString()}원</li><li><strong>결제 방법:</strong> ${c.paymentMethod}</li></ul><p><a href="${c.downloadUrl}" style="background-color: #10b981; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">영수증 다운로드</a></p>`};return"kakao"===a&&b.phone?this.sendKakaoTalk(b.phone,d.kakao):"sms"===a&&b.phone?this.sendSMS(b.phone,d.sms):"email"===a&&b.email?this.sendEmail(b.email,`[ElSpa] 영수증 ${c.receiptNumber} 발급 안내`,d.email):{success:!1,error:"유효하지 않은 채널 또는 수신자 정보"}}static async retryMessage(a,b=3){if(a.retry_count>=b)return!1;try{let b;return"kakao"===a.channel?b=await this.sendKakaoTalk(a.recipient_phone,a.content):"sms"===a.channel?b=await this.sendSMS(a.recipient_phone,a.content):"email"===a.channel&&(b=await this.sendEmail(a.recipient_email||"","인보이스 안내",a.content)),b?.success||!1}catch{return!1}}static isKorean(a){return/[㄀-ㅎ|ㅏ-ㅣ|가-힣]/.test(a)}}a.s(["default",0,function(){let{invoices:a,receipts:i,messages:j,rates:k,addMessage:l,updateMessageStatus:m,addNotification:n}=(0,d.useStore)();(0,e.useExchangeRate)();let[o,p]=(0,c.useState)("all"),[q,r]=(0,c.useState)(new Date().toISOString().slice(0,7)),[s,t]=(0,c.useState)(null),u=(0,c.useMemo)(()=>a.filter(a=>{let b="all"===o||a.status===o,c=a.settlement_month===q;return b&&c}),[a,o,q]),v=async b=>{try{let c=a.find(a=>a.id===b);if(!c)return;let d=await g.generateInvoicePDF(c,{name:"엘스파",businessNumber:"123-45-67890",address:"서울시 강남구",phone:"02-0000-0000"}),e=URL.createObjectURL(d),f=document.createElement("a");f.href=e,f.download=`${c.invoice_number}.pdf`,f.click(),n({type:"success",message:"인보이스 다운로드 완료",severity:"success",isRead:!1})}catch(a){n({type:"error",message:"인보이스 다운로드 중 오류 발생",severity:"error",isRead:!1})}},w=async(b,c)=>{try{let d=a.find(a=>a.id===b);if(!d)return;let e=await h.sendInvoiceNotification(c,{phone:"010-0000-0000",email:"guide@example.com"},{invoiceNumber:d.invoice_number,amount:d.net_amount,dueDate:new Date(d.due_date).toLocaleDateString("ko-KR"),downloadUrl:`${window.location.origin}/invoices/${b}`});e.success?(await l({invoice_id:b,recipient_phone:"010-0000-0000",recipient_email:"guide@example.com",channel:c,content:`인보이스 ${d.invoice_number} 발송`,status:"sent",sent_at:new Date().toISOString(),retry_count:0}),n({type:"success",message:`${"kakao"===c?"카카오톡":"sms"===c?"SMS":"이메일"}로 발송 완료`,severity:"success",isRead:!1})):n({type:"error",message:`${c} 발송 실패: ${e.error}`,severity:"error",isRead:!1})}catch(a){n({type:"error",message:"발송 중 오류 발생",severity:"error",isRead:!1})}},x={draft:"작성중",issued:"발급됨",sent:"발송됨",paid:"지급됨",overdue:"기한초과",cancelled:"취소됨"},y={draft:"bg-gray-100 text-gray-700",issued:"bg-blue-100 text-blue-700",sent:"bg-purple-100 text-purple-700",paid:"bg-green-100 text-green-700",overdue:"bg-red-100 text-red-700",cancelled:"bg-gray-100 text-gray-500"};return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto space-y-6",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-2",children:"💳 정산 & 영수증"}),(0,b.jsx)("p",{className:"text-lg text-gray-600 font-light",children:"인보이스 발급, 영수증 관리 및 자동 발송"})]}),(0,b.jsxs)("div",{className:"bg-white rounded-xl p-6 shadow-sm border border-stone-100 flex gap-4 items-end",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-bold text-gray-900 mb-2",children:"월"}),(0,b.jsx)("input",{type:"month",value:q,onChange:a=>r(a.target.value),className:"px-4 py-2 border border-stone-200 rounded-lg focus:outline-none focus:border-orange-500"})]}),(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-sm font-bold text-gray-900 mb-2",children:"상태"}),(0,b.jsxs)("select",{value:o,onChange:a=>p(a.target.value),className:"px-4 py-2 border border-stone-200 rounded-lg focus:outline-none focus:border-orange-500",children:[(0,b.jsx)("option",{value:"all",children:"전체"}),(0,b.jsx)("option",{value:"draft",children:"작성중"}),(0,b.jsx)("option",{value:"issued",children:"발급됨"}),(0,b.jsx)("option",{value:"sent",children:"발송됨"}),(0,b.jsx)("option",{value:"paid",children:"지급됨"}),(0,b.jsx)("option",{value:"overdue",children:"기한초과"})]})]})]}),(0,b.jsxs)("div",{className:"bg-white rounded-xl shadow-sm border border-stone-100 overflow-hidden",children:[(0,b.jsxs)("table",{className:"w-full",children:[(0,b.jsx)("thead",{children:(0,b.jsxs)("tr",{className:"bg-gray-50 border-b border-stone-200",children:[(0,b.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"인보이스"}),(0,b.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"금액"}),(0,b.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"지급기한"}),(0,b.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"상태"}),(0,b.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"작업"})]})}),(0,b.jsx)("tbody",{children:u.map(a=>(0,b.jsxs)("tr",{className:"border-b border-stone-100 hover:bg-gray-50",children:[(0,b.jsxs)("td",{className:"px-6 py-4",children:[(0,b.jsx)("div",{className:"font-semibold text-gray-900",children:a.invoice_number}),(0,b.jsx)("div",{className:"text-sm text-gray-600 font-light",children:a.settlement_month})]}),(0,b.jsx)("td",{className:"px-6 py-4 font-semibold text-gray-900",children:(0,b.jsx)(f.PriceDisplay,{amountUSD:a.net_amount/k.PHP,rates:k,compact:!0,className:"text-sm"})}),(0,b.jsx)("td",{className:"px-6 py-4 text-gray-700",children:new Date(a.due_date).toLocaleDateString("ko-KR")}),(0,b.jsx)("td",{className:"px-6 py-4",children:(0,b.jsx)("span",{className:`px-3 py-1 rounded-full text-xs font-semibold ${y[a.status]}`,children:x[a.status]})}),(0,b.jsx)("td",{className:"px-6 py-4",children:(0,b.jsxs)("div",{className:"flex gap-2",children:[(0,b.jsx)("button",{onClick:()=>v(a.id),className:"px-3 py-1 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 transition",title:"PDF 다운로드",children:"📥"}),(0,b.jsx)("button",{onClick:()=>w(a.id,"kakao"),className:"px-3 py-1 bg-yellow-500 text-white text-sm rounded hover:bg-yellow-600 transition",title:"카카오톡 발송",children:"💬"}),(0,b.jsx)("button",{onClick:()=>w(a.id,"sms"),className:"px-3 py-1 bg-purple-500 text-white text-sm rounded hover:bg-purple-600 transition",title:"SMS 발송",children:"📱"}),(0,b.jsx)("button",{onClick:()=>w(a.id,"email"),className:"px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600 transition",title:"이메일 발송",children:"✉️"})]})})]},a.id))})]}),0===u.length&&(0,b.jsx)("div",{className:"px-6 py-12 text-center text-gray-600 font-light",children:"인보이스가 없습니다."})]}),j.length>0&&(0,b.jsxs)("div",{className:"bg-white rounded-xl shadow-sm border border-stone-100 p-6",children:[(0,b.jsx)("h2",{className:"text-lg font-bold text-gray-900 mb-4",children:"📬 발송 기록"}),(0,b.jsx)("div",{className:"space-y-2 max-h-60 overflow-y-auto",children:j.slice(-10).reverse().map(a=>(0,b.jsxs)("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg text-sm",children:[(0,b.jsxs)("div",{children:[(0,b.jsxs)("span",{className:"font-semibold text-gray-900",children:["kakao"===a.channel?"💬":"sms"===a.channel?"📱":"✉️"," ",a.recipient_phone||a.recipient_email]}),(0,b.jsx)("span",{className:`ml-2 px-2 py-0.5 rounded text-xs ${"sent"===a.status?"bg-green-100 text-green-700":"bg-red-100 text-red-700"}`,children:"sent"===a.status?"전송됨":"실패"})]}),(0,b.jsx)("span",{className:"text-gray-600 font-light",children:new Date(a.sent_at||Date.now()).toLocaleTimeString("ko-KR")})]},a.id))})]})]})}],48193)}];
