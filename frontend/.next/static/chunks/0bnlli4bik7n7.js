...
✅ 아래 링크에서 영수증을 확인하세요:
${s.downloadUrl}`,sms:`[ElSpa] 영수증 ${s.receiptNumber} 발급 완료. 금액: ${s.amount.toLocaleString()}원. 상세보기: ${s.downloadUrl}`,email:`<h2>영수증 발급 완료</h2><p>안녕하세요!</p><p>지급이 완료되었습니다.</p><ul><li><strong>영수증 번호:</strong> ${s.receiptNumber}</li><li><strong>금액:</strong> ${s.amount.toLocaleString()}원</li><li><strong>결제 방법:</strong> ${s.paymentMethod}</li></ul><p><a href="${s.downloadUrl}" style="background-color: #10b981; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">영수증 다운로드</a></p>`};return"kakao"===e&&t.phone?this.sendKakaoTalk(t.phone,a.kakao):"sms"===e&&t.phone?this.sendSMS(t.phone,a.sms):"email"===e&&t.email?this.sendEmail(t.email,`[ElSpa] 영수증 ${s.receiptNumber} 발급 안내`,a.email):{success:!1,error:"유효하지 않은 채널 또는 수신자 정보"}}static async retryMessage(e,t=3){if(e.retry_count>=t)return!1;try{let t;return"kakao"===e.channel?t=await this.sendKakaoTalk(e.recipient_phone,e.content):"sms"===e.channel?t=await this.sendSMS(e.recipient_phone,e.content):"email"===e.channel&&(t=await this.sendEmail(e.recipient_email||"","인보이스 안내",e.content)),t?.success||!1}catch{return!1}}static isKorean(e){return/[㄀-ㅎ|ㅏ-ㅣ|가-힣]/.test(e)}}e.s(["default",0,function(){let{invoices:e,receipts:i,messages:d,rates:c,addMessage:p,updateMessageStatus:m,addNotification:h}=(0,a.useStore)();(0,n.useExchangeRate)();let[x,u]=(0,s.useState)("all"),[g,b]=(0,s.useState)(new Date().toISOString().slice(0,7)),[y,f]=(0,s.useState)(null),v=(0,s.useMemo)(()=>e.filter(e=>{let t="all"===x||e.status===x,s=e.settlement_month===g;return t&&s}),[e,x,g]),w=async t=>{try{let s=e.find(e=>e.id===t);if(!s)return;let a=await o.generateInvoicePDF(s,{name:"엘스파",businessNumber:"123-45-67890",address:"서울시 강남구",phone:"02-0000-0000"}),n=URL.createObjectURL(a),r=document.createElement("a");r.href=n,r.download=`${s.invoice_number}.pdf`,r.click(),h({type:"success",message:"인보이스 다운로드 완료",severity:"success",isRead:!1})}catch(e){h({type:"error",message:"인보이스 다운로드 중 오류 발생",severity:"error",isRead:!1})}},j=async(t,s)=>{try{let a=e.find(e=>e.id===t);if(!a)return;let n=await l.sendInvoiceNotification(s,{phone:"010-0000-0000",email:"guide@example.com"},{invoiceNumber:a.invoice_number,amount:a.net_amount,dueDate:new Date(a.due_date).toLocaleDateString("ko-KR"),downloadUrl:`${window.location.origin}/invoices/${t}`});n.success?(await p({invoice_id:t,recipient_phone:"010-0000-0000",recipient_email:"guide@example.com",channel:s,content:`인보이스 ${a.invoice_number} 발송`,status:"sent",sent_at:new Date().toISOString(),retry_count:0}),h({type:"success",message:`${"kakao"===s?"카카오톡":"sms"===s?"SMS":"이메일"}로 발송 완료`,severity:"success",isRead:!1})):h({type:"error",message:`${s} 발송 실패: ${n.error}`,severity:"error",isRead:!1})}catch(e){h({type:"error",message:"발송 중 오류 발생",severity:"error",isRead:!1})}},N={draft:"작성중",issued:"발급됨",sent:"발송됨",paid:"지급됨",overdue:"기한초과",cancelled:"취소됨"},S={draft:"bg-gray-100 text-gray-700",issued:"bg-blue-100 text-blue-700",sent:"bg-purple-100 text-purple-700",paid:"bg-green-100 text-green-700",overdue:"bg-red-100 text-red-700",cancelled:"bg-gray-100 text-gray-500"};return(0,t.jsxs)("div",{className:"max-w-7xl mx-auto space-y-6",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h1",{className:"text-4xl font-bold text-gray-900 mb-2",children:"💳 정산 & 영수증"}),(0,t.jsx)("p",{className:"text-lg text-gray-600 font-light",children:"인보이스 발급, 영수증 관리 및 자동 발송"})]}),(0,t.jsxs)("div",{className:"bg-white rounded-xl p-6 shadow-sm border border-stone-100 flex gap-4 items-end",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-bold text-gray-900 mb-2",children:"월"}),(0,t.jsx)("input",{type:"month",value:g,onChange:e=>b(e.target.value),className:"px-4 py-2 border border-stone-200 rounded-lg focus:outline-none focus:border-orange-500"})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("label",{className:"block text-sm font-bold text-gray-900 mb-2",children:"상태"}),(0,t.jsxs)("select",{value:x,onChange:e=>u(e.target.value),className:"px-4 py-2 border border-stone-200 rounded-lg focus:outline-none focus:border-orange-500",children:[(0,t.jsx)("option",{value:"all",children:"전체"}),(0,t.jsx)("option",{value:"draft",children:"작성중"}),(0,t.jsx)("option",{value:"issued",children:"발급됨"}),(0,t.jsx)("option",{value:"sent",children:"발송됨"}),(0,t.jsx)("option",{value:"paid",children:"지급됨"}),(0,t.jsx)("option",{value:"overdue",children:"기한초과"})]})]})]}),(0,t.jsxs)("div",{className:"bg-white rounded-xl shadow-sm border border-stone-100 overflow-hidden",children:[(0,t.jsxs)("table",{className:"w-full",children:[(0,t.jsx)("thead",{children:(0,t.jsxs)("tr",{className:"bg-gray-50 border-b border-stone-200",children:[(0,t.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"인보이스"}),(0,t.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"금액"}),(0,t.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"지급기한"}),(0,t.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"상태"}),(0,t.jsx)("th",{className:"px-6 py-4 text-left text-sm font-bold text-gray-900",children:"작업"})]})}),(0,t.jsx)("tbody",{children:v.map(e=>(0,t.jsxs)("tr",{className:"border-b border-stone-100 hover:bg-gray-50",children:[(0,t.jsxs)("td",{className:"px-6 py-4",children:[(0,t.jsx)("div",{className:"font-semibold text-gray-900",children:e.invoice_number}),(0,t.jsx)("div",{className:"text-sm text-gray-600 font-light",children:e.settlement_month})]}),(0,t.jsx)("td",{className:"px-6 py-4 font-semibold text-gray-900",children:(0,t.jsx)(r.PriceDisplay,{amountUSD:e.net_amount/c.PHP,rates:c,compact:!0,className:"text-sm"})}),(0,t.jsx)("td",{className:"px-6 py-4 text-gray-700",children:new Date(e.due_date).toLocaleDateString("ko-KR")}),(0,t.jsx)("td",{className:"px-6 py-4",children:(0,t.jsx)("span",{className:`px-3 py-1 rounded-full text-xs font-semibold ${S[e.status]}`,children:N[e.status]})}),(0,t.jsx)("td",{className:"px-6 py-4",children:(0,t.jsxs)("div",{className:"flex gap-2",children:[(0,t.jsx)("button",{onClick:()=>w(e.id),className:"px-3 py-1 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 transition",title:"PDF 다운로드",children:"📥"}),(0,t.jsx)("button",{onClick:()=>j(e.id,"kakao"),className:"px-3 py-1 bg-yellow-500 text-white text-sm rounded hover:bg-yellow-600 transition",title:"카카오톡 발송",children:"💬"}),(0,t.jsx)("button",{onClick:()=>j(e.id,"sms"),className:"px-3 py-1 bg-purple-500 text-white text-sm rounded hover:bg-purple-600 transition",title:"SMS 발송",children:"📱"}),(0,t.jsx)("button",{onClick:()=>j(e.id,"email"),className:"px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600 transition",title:"이메일 발송",children:"✉️"})]})})]},e.id))})]}),0===v.length&&(0,t.jsx)("div",{className:"px-6 py-12 text-center text-gray-600 font-light",children:"인보이스가 없습니다."})]}),d.length>0&&(0,t.jsxs)("div",{className:"bg-white rounded-xl shadow-sm border border-stone-100 p-6",children:[(0,t.jsx)("h2",{className:"text-lg font-bold text-gray-900 mb-4",children:"📬 발송 기록"}),(0,t.jsx)("div",{className:"space-y-2 max-h-60 overflow-y-auto",children:d.slice(-10).reverse().map(e=>(0,t.jsxs)("div",{className:"flex items-center justify-between p-3 bg-gray-50 rounded-lg text-sm",children:[(0,t.jsxs)("div",{children:[(0,t.jsxs)("span",{className:"font-semibold text-gray-900",children:["kakao"===e.channel?"💬":"sms"===e.channel?"📱":"✉️"," ",e.recipient_phone||e.recipient_email]}),(0,t.jsx)("span",{className:`ml-2 px-2 py-0.5 rounded text-xs ${"sent"===e.status?"bg-green-100 text-green-700":"bg-red-100 text-red-700"}`,children:"sent"===e.status?"전송됨":"실패"})]}),(0,t.jsx)("span",{className:"text-gray-600 font-light",children:new Date(e.sent_at||Date.now()).toLocaleTimeString("ko-KR")})]},e.id))})]})]})}],2999)}]);