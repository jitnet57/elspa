...
export const translations = {
  en: {
    ...
    // SSS Option Select (정부 선지급 vs 유연한 보류)
    sss_option_title: 'SSS Contribution Settlement Method',
    sss_option_subtitle: 'Monthly Payroll — Choose between Government Invoice Prepaid or Flexible Hold',
    sss_option_prepaid_label: 'Government Invoice Prepaid',
    sss_option_prepaid_desc: 'Calculate and advance pay immediately based on government invoice criteria',
    sss_option_hold_label: 'Flexible Hold',
    sss_option_hold_desc: 'Flexibly settle based on actual work status and attendance',
    sss_badge_government: 'Government Invoice',
    sss_badge_flexible: 'Flexible',
    sss_payroll_impact: 'Payroll Impact',
    ...
    sss_tax_implications: 'Tax Implications',
    sss_tax_info_default: 'Tax information is being calculated...',
    sss_important_note: 'Important Notice',
    sss_note_prepaid: 'Prepaid: Fixed amount based on government invoice criteria, automatically deducted monthly',
    sss_note_hold: 'Hold: Flexible settlement based on actual work hours and event participation',
    sss_note_settlement: 'Settlement deadline: 25th of every month',
    sss_processing: 'Processing...',
  },
  ...
  ko: {
    ...
    // SSS 기여금 정산 방식 (정부 선지급 vs 유연한 보류)
    sss_option_title: 'SSS 기여금 정산 방식',
    sss_option_subtitle: '월별 급여 — 정부 인보이스 선지급 또는 유연한 보류 중 선택',
    sss_option_prepaid_label: '정부 인보이스 선지급',
    sss_option_prepaid_desc: '정부 인보이스 기준으로 즉시 계산 및 선지급',
    sss_option_hold_label: '유연한 보류',
    sss_option_hold_desc: '실제 근무 현황과 출근도에 따라 유연하게 정산',
    sss_badge_government: '정부 인보이스',
    sss_badge_flexible: '유연함',
    sss_payroll_impact: '급여 영향도',
    sss_gross_salary: '총 급여',
    sss_contribution: 'SSS 기여금',
    sss_prepaid_amount: '선지급액',
    sss_hold_amount: '보류액',
    sss_settlement_date: '정산 예정일',
    sss_tax_implications: '세금 영향도',
    sss_tax_info_default: '세금 정보 계산 중...',
    sss_important_note: '중요 안내',
    sss_note_prepaid: '선지급: 정부 인보이스 기준의 고정액으로 매월 자동 공제됨',
    sss_note_hold: '보류: 실제 근무 시간과 이벤트 참여도를 기반으로 유연하게 정산',
